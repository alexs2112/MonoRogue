...
namespace MonoRogue {
    public struct Constants {
        ...
        public static string SettingsPath = "BlueSettings.settings";// Relative path to the settings file
        public static string SavegamePath = "BlueSave.savegame";    // Relative path to the currently saved game
        public static string HistoryPath = "BlueHistory.morgue";    // Relative path to the game history (previous games)
